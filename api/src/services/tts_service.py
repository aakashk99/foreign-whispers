    ...
    def text_file_to_speech(
        ...
        *,
        ...
        Args:
            ...
            speaker_wav_map:  Optional ``{speaker_label: wav_path}`` mapping.
                              When provided and segments carry a ``speaker``
                              field, each segment is synthesised with the
                              corresponding reference voice.
        """
